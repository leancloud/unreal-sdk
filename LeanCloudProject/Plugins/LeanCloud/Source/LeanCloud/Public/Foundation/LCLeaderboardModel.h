...
struct LEANCLOUD_API FLCLeaderboardStatistic {
	...
	FLCLeaderboardStatistic(const FLCValue& Content, const TSharedPtr<FLCApplication>& AppPtr);
};
...
struct LEANCLOUD_API FLCLeaderboardRanking {
	...
	FLCLeaderboardRanking(const FLCValue& Content, const TSharedPtr<FLCApplication>& AppPtr);
};
